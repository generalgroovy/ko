...
GUI_PLUGINS: tuple[GuiPlugin, ...] = (
    ...
    GuiPlugin("arranger", "ko2_daw.gui_arranger", "apply_arranger_patch", 105),
    GuiPlugin("device-snapshot", "ko2_daw.gui_device_snapshot", "apply_device_snapshot_patch", 110),
    GuiPlugin("device-library", "ko2_daw.gui_device_library", "apply_device_library_patch", 120),
    GuiPlugin("project-catalog", "ko2_daw.gui_project_catalog", "apply_project_catalog_patch", 125),
    GuiPlugin("modern-shell", "ko2_daw.gui_modern_shell", "apply_modern_shell_patch", 190),
